  ...
  <div class="layout">
    <header class="header">
      ...
      <div class="header-right">
        <span class="greeting">👋 {{ greetingTime }}好，老师</span>
        <span class="role-tag teacher">教师</span>
    ...
    <div class="main-container">
      <aside class="sidebar">
        ...
        <nav class="nav-menu">
          ...
          <router-link to="/teacher/history" class="nav-item">
            <span class="nav-icon">📊</span>
            <span class="nav-text">历史统计</span>
          </router-link>
          <router-link to="/teacher/exceptions" class="nav-item">
            <span class="nav-icon">⚠️</span>
            <span class="nav-text">异常复核</span>
          </router-link>
        </nav>
