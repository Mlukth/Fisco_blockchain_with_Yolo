...
const pages = {
  ...
  'admin-devices': () => import('@/views/admin/Devices.vue'),
  'admin-config': () => import('@/views/admin/Config.vue'),
  'admin-diagnosis': () => import('@/views/admin/Diagnosis.vue'),
  'teacher-class': () => import('@/views/teacher/ClassAttendance.vue'),
  'teacher-history': () => import('@/views/teacher/History.vue'),
  'teacher-review': () => import('@/views/teacher/Review.vue'),
  'parent-attendance': () => import('@/views/parent/Attendance.vue'),
  'parent-history': () => import('@/views/parent/History.vue'),
  verify: () => import('@/views/Verify.vue'),
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin', component: layouts.admin, meta: { requiresAuth: true, role: 'admin' }, children: [
      ...
      { path: 'config', component: pages['admin-config'] },
      { path: 'diagnosis', component: pages['admin-diagnosis'] },
    ]},
    { path: '/teacher', component: layouts.teacher, meta: { requiresAuth: true, role: 'teacher' }, children: [
      { path: '', redirect: '/teacher/class' },
      { path: 'class', component: pages['teacher-class'] },
      { path: 'history', component: pages['teacher-history'] },
      { path: 'review', component: pages['teacher-review'] },
    ]},
    { path: '/parent', component: layouts.parent, meta: { requiresAuth: true, role: 'parent' }, children: [
    ...
    { path: '/verify', component: pages.verify, meta: { requiresAuth: true } },
    { path: '/upload', component: pages.upload, meta: { requiresAuth: true, role: 'teacher' } },
    { path: '/', redirect: () => {
