      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
        ...
        <div class="flex items-center">
          <div class="flex-shrink-0 flex items-center">
            ...
            <span class="font-bold text-lg text-white">考勤存证系统</span>
          </div>
        </div>
...
const navButtons = [
  ...
  { id: 'upload', label: '考勤采集', icon: 'fa-cloud-upload', path: '/upload' },
  { id: 'verify', label: '考勤验真', icon: 'fa-check-circle', path: '/verify' },
